...
/* INSERT RECORD (AUTO, NO DUPLICATE) */
...
mysqli_query($conn,"
INSERT INTO record
(CheckupDate, CheckupTime, IC_Number, Name, Booking_REF, Doctor_ID)
SELECT appointment_date, Time, IC_Number, Name, Booking_REF, Doctor_ID
FROM booking
WHERE Booking_REF='$booking_ref'
");
}
...
<input type="hidden" name="booking_ref" value="<?php echo $row['Booking_REF']; ?>">
</td>
...
<?php if($row['Doctor_ID']==$d['Doctor_ID']) echo "selected"; ?>>
