...
<a
href="patientdetails.php?record_ref=<?php echo $row['Record_REF'];?>"
class="view-btn">
...
<a
href="healthassessment.php?record_ref=<?php echo $row['Record_REF'];?>"
